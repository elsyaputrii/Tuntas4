...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white/90 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-gray-800 text-lg">TUNTAS</h1>
      ...
      {!activeTab && (
        <HeroSection
          onBuatLaporan={() => setActiveTab("form")}
          onCekStatus={() => setActiveTab("status")}
        />
      )}
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span className="text-blue-600 font-medium">
              {activeTab === "form" ? "Buat Laporan" : "Cek Status Laporan"}
            </span>
          </div>
